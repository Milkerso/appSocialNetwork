...
<head>
    ...
    <script type="text/javascript">
        ...
        function startSearch(pParam) {
            ...
            var searchLink = '${pageContext.request.contextPath}/admin/users/search/' + searchName
					+ '/' + searchLastName + '/' + searchEmail + '/' + page;
                ...
                <table style="margin-top: 10px" class="table table-striped table-bordered" width="1000" border="0" cellpadding="6"
                    ...
                    <c:forEach var="u" items="${userList }">
                        ...
                        <tr onmouseover="changeTrBg(this)" onmouseout="defaultTrBg(this)">
                            ...
                            <td align="left"><a href="edit/${u.id }"><c:out value="${u.userProfile.lastName }"/></a>
                            </td>
