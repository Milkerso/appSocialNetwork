                        ...
                        <ul class="list-group" id="contact-list">
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div>
                                    <span class="name"><c:out value="${user.name }"/> <c:out value="${user.lastName }"/></span><br/>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                <span class="glyphicon glyphicon-map-marker text-muted c-info" data-toggle="tooltip" title="5842 Hillcrest Rd"></span>
                                <span class="visible-xs"> <span class="text-muted"><c:out value="${user.city }"/></span><br/></span>
                                <span class="glyphicon glyphicon-earphone text-muted c-info" data-toggle="tooltip" title="(870) 288-4149"></span>
                                <span class="visible-xs"> <span class="text-muted"><c:out value="${user.number }"/></span><br/></span>
                                <span class="fa fa-comments text-muted c-info" data-toggle="tooltip" title="scott.stevens@example.com"></span>
                                <span class="visible-xs"> <span class="text-muted"><c:out value="${user.email }"/></span><br/></span>
